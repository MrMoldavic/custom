...
/**
 * \file    test/phpunit/DonateurFunctionalTest.php
 * \ingroup donateur
 ...
 *
 * @package Testdonateur
 */
class DonateurFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/donateur/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('donateur/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/donateur/admin/about.php');
		$this->authenticate();
		return $this->assertContains('donateur/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('donateurwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modDonateur_DonateurTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modDonateur_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
