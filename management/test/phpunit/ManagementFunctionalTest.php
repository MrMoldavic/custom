...
/**
 * \file    test/phpunit/ManagementFunctionalTest.php
 * \ingroup management
...
/**
 * Class ManagementFunctionalTest
 *
 ...
 */
class ManagementFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modManagement')->click();
		} else {
			// Disable the module
			$this->byHref('modManagement')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/management/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('management/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/management/admin/about.php');
		$this->authenticate();
		return $this->assertContains('management/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('managementwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modManagement_ManagementTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modManagement_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
