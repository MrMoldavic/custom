...
/**
 *	Class to manage PDF template standard_statut
 */
class pdf_standard_statut extends ModelePDFStatut
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		/*
		if (!empty($conf->global->MAIN_GENERATE_STATUT_WITH_PICTURE))
		{
		...
		*/
		...
		if ($conf->management->dir_output.'/statut') {
			$object->fetch_thirdparty();

			// Definition of $dir and $file
			if ($object->specimen) {
				$dir = $conf->management->dir_output.'/statut';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->management->dir_output.'/statut/'.$objectref;
