...
/**
 *  \file       core/modules/management/doc/pdf_standard.modules.php
 *  \ingroup    management
...
/**
 *	Class to manage PDF template standard_typecontrat
 */
class pdf_standard_typecontrat extends ModelePDFTypeContrat
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		/*
		if (!empty($conf->global->MAIN_GENERATE_TYPECONTRAT_WITH_PICTURE))
		{
		...
		*/
		...
		if ($conf->management->dir_output.'/typecontrat') {
			$object->fetch_thirdparty();

			// Definition of $dir and $file
			if ($object->specimen) {
				$dir = $conf->management->dir_output.'/typecontrat';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->management->dir_output.'/typecontrat/'.$objectref;
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $outputlangsbis = null)
	{
		...
		if ($object->statut == $object::STATUS_DRAFT && getDolGlobalString('MANAGEMENT_DRAFT_WATERMARK')) {
			pdf_watermark($pdf, $outputlangs, $this->page_hauteur, $this->page_largeur, 'mm', dol_escape_htmltag(getDolGlobalString('MANAGEMENT_DRAFT_WATERMARK')));
		}
