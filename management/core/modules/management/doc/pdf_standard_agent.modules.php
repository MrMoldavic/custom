...
/**
 *	Class to manage PDF template standard_agent
 */
class pdf_standard_agent extends ModelePDFAgent
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		/*
		if (!empty($conf->global->MAIN_GENERATE_AGENT_WITH_PICTURE))
		{
		...
		*/
		...
		if ($conf->management->dir_output.'/agent') {
			$object->fetch_thirdparty();

			// Definition of $dir and $file
			if ($object->specimen) {
				$dir = $conf->management->dir_output.'/agent';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->management->dir_output.'/agent/'.$objectref;
