...
/**
 *  \file       appetence_agenda.php
 *  \ingroup    management
 *  \brief      Tab of events on Appetence
 */
...
$hookmanager->initHooks(array('appetenceagenda', 'globalcard')); // Note that conf->hooks_modules contains array
...
if ($object->id > 0) {
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("Appetence"), -1, $object->picto);
	...
	if (isModEnabled('agenda') && (!empty($user->rights->agenda->myactions->read) || !empty($user->rights->agenda->allactions->read))) {
		...
		//print load_fiche_titre($langs->trans("ActionsOnAppetence"), '', '');
		print_barre_liste($langs->trans("ActionsOnAppetence"), 0, $_SERVER["PHP_SELF"], '', $sortfield, $sortorder, '', 0, -1, '', 0, $morehtmlright, '', 0, 1, 1);
