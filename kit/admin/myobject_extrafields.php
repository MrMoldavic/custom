...
$elementtype = 'kit_myobject'; //Must be the $table_element of the class that manage extrafield
...
llxHeader('', $langs->trans("KitSetup"), $help_url);


$linkback = '<a href="'.DOL_URL_ROOT.'/admin/modules.php?restore_lastsearch_values=1">'.$langs->trans("BackToModuleList").'</a>';
print load_fiche_titre($langs->trans("KitSetup"), $linkback, 'title_setup');
