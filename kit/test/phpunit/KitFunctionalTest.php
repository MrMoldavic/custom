...
/**
 * \file    test/phpunit/KitFunctionalTest.php
 * \ingroup kit
 ...
 * @package Testkit
 */
class KitFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/kit/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('kit/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/kit/admin/about.php');
		$this->authenticate();
		return $this->assertContains('kit/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('kitwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modKit_KitTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modKit_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
