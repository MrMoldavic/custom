...
/**
 *	\file       kit/kitindex.php
 *	\ingroup    kit
 *	\brief      Home page of kit top menu
 */
...
$langs->loadLangs(array("kit@kit"));

$action = GETPOST('action', 'alpha');


// Security check
//if (! $user->rights->kit->myobject->read) accessforbidden();
...
llxHeader("", $langs->trans("KitArea"));

print load_fiche_titre($langs->trans("KitArea"), '', 'kit.png@kit');
...
// Draft MyObject
if (! empty($conf->kit->enabled) && $user->rights->kit->read)
{
	$langs->load("orders");
