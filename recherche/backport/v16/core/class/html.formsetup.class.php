...
class FormSetup
{
	...
	public function addItemFromParams($confKey, $params)
	{
		 ...
		 * 	// 'RECHERCHE_MYPARAM1'=>array('type'=>'string', 'css'=>'minwidth500' ,'enabled'=>1),
			// 'RECHERCHE_MYPARAM2'=>array('type'=>'textarea','enabled'=>1),
			//'RECHERCHE_MYPARAM3'=>array('type'=>'category:'.Categorie::TYPE_CUSTOMER, 'enabled'=>1),
			//'RECHERCHE_MYPARAM4'=>array('type'=>'emailtemplate:thirdparty', 'enabled'=>1),
			//'RECHERCHE_MYPARAM5'=>array('type'=>'yesno', 'enabled'=>1),
			//'RECHERCHE_MYPARAM5'=>array('type'=>'thirdparty_type', 'enabled'=>1),
			//'RECHERCHE_MYPARAM6'=>array('type'=>'securekey', 'enabled'=>1),
			//'RECHERCHE_MYPARAM7'=>array('type'=>'product', 'enabled'=>1),
		 */
