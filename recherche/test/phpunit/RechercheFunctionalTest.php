...
/**
 * \file    test/phpunit/RechercheFunctionalTest.php
 * \ingroup recherche
 ...
 */
class RechercheFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	private static $module_id = 520000; // TODO: autodetect?
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modRecherche')->click();
		} else {
			// Disable the module
			$this->byHref('modRecherche')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/recherche/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('recherche/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/recherche/admin/about.php');
		$this->authenticate();
		return $this->assertContains('recherche/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('recherchewidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modRecherche_RechercheTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modRecherche_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
