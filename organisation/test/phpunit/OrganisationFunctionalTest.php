...
/**
 * \file    test/phpunit/OrganisationFunctionalTest.php
...
/**
 * Class OrganisationFunctionalTest
 *
 ...
 *
 * @package Testorganisation
 */
class OrganisationFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modOrganisation')->click();
		} else {
			// Disable the module
			$this->byHref('modOrganisation')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/organisation/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('organisation/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/organisation/admin/about.php');
		$this->authenticate();
		return $this->assertContains('organisation/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('organisationwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modOrganisation_OrganisationTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modOrganisation_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
