...
/**
 *  \file       programmation_agenda.php
 *  \ingroup    organisation
 *  \brief      Tab of events on Programmation
 */
...
$hookmanager->initHooks(array('programmationagenda', 'globalcard')); // Note that conf->hooks_modules contains array
...
if ($object->id > 0) {
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("Programmation"), -1, $object->picto);
	...
	if (isModEnabled('agenda') && (!empty($user->rights->agenda->myactions->read) || !empty($user->rights->agenda->allactions->read))) {
		...
		//print load_fiche_titre($langs->trans("ActionsOnProgrammation"), '', '');
		print_barre_liste($langs->trans("ActionsOnProgrammation"), 0, $_SERVER["PHP_SELF"], '', $sortfield, $sortorder, '', 0, -1, '', 0, $morehtmlright, '', 0, 1, 1);
