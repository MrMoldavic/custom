...
/**
 *  \file       core/modules/organisation/doc/pdf_standard.modules.php
...
/**
 *	Class to manage PDF template standard_liaisoninstrument
 */
class pdf_standard_liaisoninstrument extends ModelePDFLiaisonInstrument
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		/*
		if (!empty($conf->global->MAIN_GENERATE_LIAISONINSTRUMENT_WITH_PICTURE))
		{
		...
		*/
		...
		if ($conf->organisation->dir_output.'/liaisoninstrument') {
			$object->fetch_thirdparty();

			// Definition of $dir and $file
			if ($object->specimen) {
				$dir = $conf->organisation->dir_output.'/liaisoninstrument';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->organisation->dir_output.'/liaisoninstrument/'.$objectref;
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $outputlangsbis = null)
	{
		...
		if ($object->statut == $object::STATUS_DRAFT && getDolGlobalString('ORGANISATION_DRAFT_WATERMARK')) {
			pdf_watermark($pdf, $outputlangs, $this->page_hauteur, $this->page_largeur, 'mm', dol_escape_htmltag(getDolGlobalString('ORGANISATION_DRAFT_WATERMARK')));
		}
