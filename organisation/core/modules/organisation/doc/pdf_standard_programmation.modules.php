...
/**
 *	Class to manage PDF template standard_programmation
 */
class pdf_standard_programmation extends ModelePDFProgrammation
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		/*
		if (!empty($conf->global->MAIN_GENERATE_PROGRAMMATION_WITH_PICTURE))
		{
		...
		*/
		...
		if ($conf->organisation->dir_output.'/programmation') {
			$object->fetch_thirdparty();

			// Definition of $dir and $file
			if ($object->specimen) {
				$dir = $conf->organisation->dir_output.'/programmation';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->organisation->dir_output.'/programmation/'.$objectref;
