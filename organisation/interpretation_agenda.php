...
/**
 *  \file       interpretation_agenda.php
 *  \ingroup    organisation
 *  \brief      Tab of events on Interpretation
 */
...
$hookmanager->initHooks(array('interpretationagenda', 'globalcard')); // Note that conf->hooks_modules contains array
...
if ($object->id > 0) {
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("Interpretation"), -1, $object->picto);
	...
	if (isModEnabled('agenda') && (!empty($user->rights->agenda->myactions->read) || !empty($user->rights->agenda->allactions->read))) {
		...
		//print load_fiche_titre($langs->trans("ActionsOnInterpretation"), '', '');
