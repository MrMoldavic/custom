...
/**
 *   	\file       programmation_list.php
 *		\ingroup    organisation
 *		\brief      List page for programmation
 */
...
require_once __DIR__.'/class/programmation.class.php';
...
$hookmanager->initHooks(array('programmationlist')); // Note that conf->hooks_modules contains array
...
if ($enablepermissioncheck) {
	...
	$permissiontoadd = $user->hasRight('organisation', 'programmation', 'write');
	$permissiontodelete = $user->hasRight('organisation', 'programmation', 'delete');
} else {
	$permissiontoread = 1;
	$permissiontoadd = 1;
...
if (empty($reshook)) {
	...
	// Mass actions
	$objectclass = 'Programmation';
	$objectlabel = 'Programmation';
...
//$help_url = "EN:Module_Programmation|FR:Module_Programmation_FR|ES:Módulo_Programmation";
$help_url = '';
$title = $langs->trans("Programmations");
$morejs = array();
$morecss = array();
...
if ($num == 1 && !empty($conf->global->MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE) && $search_all && !$page) {
	...
	$id = $obj->rowid;
	header("Location: ".dol_buildpath('/organisation/programmation_card.php', 1).'?id='.$id);
	exit;
}
...
$newcardbutton .= dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/organisation/programmation_card.php', 1).'?action=create&backtopage='.urlencode($_SERVER['PHP_SELF']), '', $permissiontoadd);

print_barre_liste($title, $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, $massactionbutton, $num, $nbtotalofrecords, 'object_'.$object->picto, 0, $newcardbutton, '', $limit, 0, 0, 1);

// Add code for pre mass action (confirmation or email presend form)
$topicmail = "SendProgrammationRef";
$modelmail = "programmation";
$objecttmp = new Programmation($db);
