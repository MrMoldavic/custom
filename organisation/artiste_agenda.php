...
/**
 *  \file       artiste_agenda.php
 *  \ingroup    organisation
 *  \brief      Tab of events on Artiste
 */
...
$hookmanager->initHooks(array('artisteagenda', 'globalcard')); // Note that conf->hooks_modules contains array
...
if ($object->id > 0) {
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("Artiste"), -1, $object->picto);
	...
	if (isModEnabled('agenda') && (!empty($user->rights->agenda->myactions->read) || !empty($user->rights->agenda->allactions->read))) {
		...
		//print load_fiche_titre($langs->trans("ActionsOnArtiste"), '', '');
