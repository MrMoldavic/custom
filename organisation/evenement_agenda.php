...
/**
 *  \file       evenement_agenda.php
 *  \ingroup    organisation
 *  \brief      Tab of events on Evenement
 */
...
$hookmanager->initHooks(array('evenementagenda', 'globalcard')); // Note that conf->hooks_modules contains array
...
if ($object->id > 0) {
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("Evenement"), -1, $object->picto);
	...
	if (isModEnabled('agenda') && (!empty($user->rights->agenda->myactions->read) || !empty($user->rights->agenda->allactions->read))) {
		...
		//print load_fiche_titre($langs->trans("ActionsOnEvenement"), '', '');
