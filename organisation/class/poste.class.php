 ...
 * Class for Poste
 */
class Poste extends CommonObject
{
	/**
	 ...
	 */
	public $element = 'poste';

	/**
	 * @var string Name of table without prefix where object is stored. This is also the key used for extrafields management.
	 */
	public $table_element = 'organisation_poste';
	...
	public $fields=array(
		...
		'fk_evenement' => array('type'=>'integer:Evenement:custom/organisation/class/evenement.class.php:1', 'label'=>'Événement', 'enabled'=>'1', 'position'=>1, 'notnull'=>1, 'visible'=>1, 'searchall'=>1, 'showoncombobox'=>'1', 'validate'=>'1', 'comment'=>"Reference of object"),
		'fk_type_poste' => array('type'=>'sellist:organisation_c_type_poste:poste', 'label'=>'Type de poste', 'enabled'=>'1', 'position'=>2, 'notnull'=>1, 'visible'=>1, 'searchall'=>1, 'comment'=>"Reference of object"),
		'fk_agent' => array('type'=>'integer:Agent:custom/management/class/agent.class.php:1', 'label'=>'Agent', 'enabled'=>'1', 'position'=>3, 'notnull'=>0, 'visible'=>1, 'searchall'=>1, 'comment'=>"Reference of object"),
		'fk_etat_convocation' => array('type'=>'sellist:organisation_c_etat_convocation:etat', 'label'=>'Etat de la convation', 'enabled'=>'1', 'position'=>4, 'notnull'=>0, 'visible'=>1, 'searchall'=>1, 'comment'=>"Reference of object"),
		'presence' => array('type'=>'boolean', 'label'=>'Présence', 'enabled'=>'1', 'position'=>5, 'notnull'=>0, 'visible'=>1, 'searchall'=>1, 'comment'=>"Reference of object"),
 ...
 */
class PosteLine extends CommonObjectLine
{
