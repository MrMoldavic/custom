...
/**
 * \file    test/phpunit/SourceFunctionalTest.php
 * \ingroup source
 ...
 * @package Testsource
 */
class SourceFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/source/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('source/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/source/admin/about.php');
		$this->authenticate();
		return $this->assertContains('source/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('sourcewidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modSource_SourceTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modSource_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
