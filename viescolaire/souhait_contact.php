...
/**
 *  \file       souhait_contact.php
 *  \ingroup    viescolaire
 *  \brief      Tab for contacts linked to Souhait
 */
...
$hookmanager->initHooks(array('souhaitcontact', 'globalcard')); // Note that conf->hooks_modules contains array
...
$title = $langs->trans('Souhait')." - ".$langs->trans('ContactsAddresses');
$help_url = '';
...
if ($object->id) {
	...
	print dol_get_fiche_head($head, 'contact', $langs->trans("Souhait"), -1, $object->picto);
	...
	dol_banner_tab($object, 'ref', $linkback, 1, 'ref', 'nom_souhait', $morehtmlref, '', 0, '', '', 1);
