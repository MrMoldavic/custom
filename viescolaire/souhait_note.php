...
/**
 *  \file       souhait_note.php
 *  \ingroup    viescolaire
 *  \brief      Tab for notes on Souhait
 */
...
$hookmanager->initHooks(array('souhaitnote', 'globalcard')); // Note that conf->hooks_modules contains array
...
$help_url = '';
llxHeader('', $langs->trans('Souhait'), $help_url);
...
if ($id > 0 || !empty($ref)) {
	...
	print dol_get_fiche_head($head, 'note', $langs->trans("Souhait"), -1, $object->picto);
