...
/**
 *  \file       appel_contact.php
 *  \ingroup    viescolaire
 *  \brief      Tab for contacts linked to Appel
 */
...
$hookmanager->initHooks(array('appelcontact', 'globalcard')); // Note that conf->hooks_modules contains array
...
$title = $langs->trans('Appel')." - ".$langs->trans('ContactsAddresses');
$help_url = '';
...
if ($object->id) {
	...
	print dol_get_fiche_head($head, 'contact', $langs->trans("Appel"), -1, $object->picto);
