...
/**
 *   	\file       contributioncontent_list.php
 *		\ingroup    viescolaire
 *		\brief      List page for contributioncontent
 */
...
require_once __DIR__.'/class/contributioncontent.class.php';
...
$hookmanager->initHooks(array('contributioncontentlist')); // Note that conf->hooks_modules contains array
...
if ($enablepermissioncheck) {
	...
	$permissiontoadd = $user->hasRight('viescolaire', 'contributioncontent', 'write');
	$permissiontodelete = $user->hasRight('viescolaire', 'contributioncontent', 'delete');
} else {
	$permissiontoread = 1;
	$permissiontoadd = 1;
...
if (empty($reshook)) {
	...
	// Mass actions
	$objectclass = 'ContributionContent';
	$objectlabel = 'ContributionContent';
...
//$help_url = "EN:Module_ContributionContent|FR:Module_ContributionContent_FR|ES:Módulo_ContributionContent";
$help_url = '';
$title = $langs->trans("ContributionContents");
$morejs = array();
$morecss = array();
...
if ($num == 1 && !empty($conf->global->MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE) && $search_all && !$page) {
	...
	$id = $obj->rowid;
	header("Location: ".dol_buildpath('/viescolaire/contributioncontent_card.php', 1).'?id='.$id);
	exit;
}
...
$newcardbutton .= dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/viescolaire/contributioncontent_card.php', 1).'?action=create&backtopage='.urlencode($_SERVER['PHP_SELF']), '', $permissiontoadd);

print_barre_liste($title, $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, $massactionbutton, $num, $nbtotalofrecords, 'object_'.$object->picto, 0, $newcardbutton, '', $limit, 0, 0, 1);

// Add code for pre mass action (confirmation or email presend form)
$topicmail = "SendContributionContentRef";
$modelmail = "contributioncontent";
$objecttmp = new ContributionContent($db);
