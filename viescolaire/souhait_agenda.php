...
/**
 *  \file       souhait_agenda.php
 *  \ingroup    viescolaire
 *  \brief      Tab of events on Souhait
 */
...
$hookmanager->initHooks(array('souhaitagenda', 'globalcard')); // Note that conf->hooks_modules contains array
...
if ($object->id > 0) {
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("Souhait"), -1, $object->picto);
	...
	if (!empty($conf->agenda->enabled) && (!empty($user->rights->agenda->myactions->read) || !empty($user->rights->agenda->allactions->read))) {
		...
		//print load_fiche_titre($langs->trans("ActionsOnSouhait"), '', '');
