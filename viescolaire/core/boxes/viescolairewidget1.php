...
/**
 * \file    viescolaire/core/boxes/viescolairewidget1.php
 * \ingroup viescolaire
 * \brief   Widget provided by VieScolaire
 *
 ...
 */
class viescolairewidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "viescolairebox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "viescolaire@viescolaire";
	 ...
	 */
	public $depends = array('viescolaire');
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		// Translations
		$langs->loadLangs(array("boxes", "viescolaire@viescolaire"));
		...
		//$this->hidden = ! ($user->rights->viescolaire->myobject->read);   // Condition when module is visible by user (test on permission)
	}
	...
	public function loadBox($max = 5)
	{
		...
		//dol_include_once("/viescolaire/class/viescolaire.class.php");

		// Populate the head at runtime
		$text = $langs->trans("VieScolaireBoxDescription", $max);
		$this->info_box_head = array(
			...
			'subpicto' => 'object_viescolaire@viescolaire',
