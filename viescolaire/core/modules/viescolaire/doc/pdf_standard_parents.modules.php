...
/**
 *	Class to manage PDF template standard_parents
 */
class pdf_standard_parents extends ModelePDFParents
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		/*
		if (!empty($conf->global->MAIN_GENERATE_PARENTS_WITH_PICTURE))
		{
		...
		*/
		...
		if ($conf->viescolaire->dir_output.'/parents') {
			$object->fetch_thirdparty();

			// Definition of $dir and $file
			if ($object->specimen) {
				$dir = $conf->viescolaire->dir_output.'/parents';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->viescolaire->dir_output.'/parents/'.$objectref;
