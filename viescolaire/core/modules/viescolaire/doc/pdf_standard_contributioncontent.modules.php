...
/**
 *  \file       core/modules/viescolaire/doc/pdf_standard.modules.php
 *  \ingroup    viescolaire
...
/**
 *	Class to manage PDF template standard_contributioncontent
 */
class pdf_standard_contributioncontent extends ModelePDFContributionContent
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		/*
		if (!empty($conf->global->MAIN_GENERATE_CONTRIBUTIONCONTENT_WITH_PICTURE))
		{
		...
		*/
		...
		if ($conf->viescolaire->dir_output.'/contributioncontent') {
			$object->fetch_thirdparty();

			// Definition of $dir and $file
			if ($object->specimen) {
				$dir = $conf->viescolaire->dir_output.'/contributioncontent';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->viescolaire->dir_output.'/contributioncontent/'.$objectref;
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $outputlangsbis = null)
	{
		...
		if ($object->statut == $object::STATUS_DRAFT && getDolGlobalString('VIESCOLAIRE_DRAFT_WATERMARK')) {
			pdf_watermark($pdf, $outputlangs, $this->page_hauteur, $this->page_largeur, 'mm', dol_escape_htmltag(getDolGlobalString('VIESCOLAIRE_DRAFT_WATERMARK')));
		}
