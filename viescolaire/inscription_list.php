...
/**
 *   	\file       inscription_list.php
 *		\ingroup    viescolaire
 *		\brief      List page for inscription
 */
...
require_once __DIR__.'/class/inscription.class.php';
...
$hookmanager->initHooks(array('inscriptionlist')); // Note that conf->hooks_modules contains array
...
if ($enablepermissioncheck) {
	...
	$permissiontoadd = $user->hasRight('viescolaire', 'inscription', 'write');
	$permissiontodelete = $user->hasRight('viescolaire', 'inscription', 'delete');
} else {
	$permissiontoread = 1;
	$permissiontoadd = 1;
...
//$help_url = "EN:Module_Inscription|FR:Module_Inscription_FR|ES:Módulo_Inscription";
$help_url = '';
...
if ($num == 1 && !empty($conf->global->MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE) && $search_all && !$page) {
	...
	$id = $obj->rowid;
	header("Location: ".dol_buildpath('/viescolaire/inscription_card.php', 1).'?id='.$id);
	exit;
}
...
$newcardbutton .= dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/viescolaire/inscription_card.php', 1).'?action=create&backtopage='.urlencode($_SERVER['PHP_SELF']), '', $permissiontoadd);

print_barre_liste($title, $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, $massactionbutton, $num, $nbtotalofrecords, 'object_'.$object->picto, 0, $newcardbutton, '', $limit, 0, 0, 1);

// Add code for pre mass action (confirmation or email presend form)
$topicmail = "SendInscriptionRef";
$modelmail = "inscription";
$objecttmp = new Inscription($db);
