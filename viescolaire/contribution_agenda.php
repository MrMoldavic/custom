...
/**
 *  \file       contribution_agenda.php
 *  \ingroup    viescolaire
 *  \brief      Tab of events on Contribution
 */
...
$hookmanager->initHooks(array('contributionagenda', 'globalcard')); // Note that conf->hooks_modules contains array
...
if ($object->id > 0) {
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("Contribution"), -1, $object->picto);
	...
	if (isModEnabled('agenda') && (!empty($user->rights->agenda->myactions->read) || !empty($user->rights->agenda->allactions->read))) {
		...
		//print load_fiche_titre($langs->trans("ActionsOnContribution"), '', '');
		print_barre_liste($langs->trans("ActionsOnContribution"), 0, $_SERVER["PHP_SELF"], '', $sortfield, $sortorder, '', 0, -1, '', 0, $morehtmlright, '', 0, 1, 1);
