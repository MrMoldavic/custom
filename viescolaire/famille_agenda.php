...
/**
 *  \file       famille_agenda.php
 *  \ingroup    viescolaire
 *  \brief      Tab of events on Famille
 */
...
$hookmanager->initHooks(array('familleagenda', 'globalcard')); // Note that conf->hooks_modules contains array
...
if ($object->id > 0) {
	...
	if (!empty($conf->agenda->enabled) && (!empty($user->rights->agenda->myactions->read) || !empty($user->rights->agenda->allactions->read))) {
		...
		//print load_fiche_titre($langs->trans("ActionsOnFamille"), '', '');
