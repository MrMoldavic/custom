...
$hookmanager->initHooks(array('souhaitlist')); // Note that conf->hooks_modules contains array
...
//$help_url="EN:Module_Souhait|FR:Module_Souhait_FR|ES:Módulo_Souhait";
$help_url = '';
