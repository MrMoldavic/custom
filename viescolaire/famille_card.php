...
if( $action == 'stateModify')
{
	...
	setEventMessage('Abandon noté avec succès!');
}
...
if ($object->id > 0 && (empty($action) || ($action != 'edit' && $action != 'create'))) {
	...
	print dolGetButtonAction($langs->trans('Créer un don parent 1'), '', 'default', '/don/card.php?leftmenu=donations&action=create&firstname='.$object->prenom_parent_1.'&lastname='.$object->nom_parent_1.'&fk_country=1&email='.$object->mail_parent_1.'&phone='.$object->tel_parent_1.'&address='.$object->adresse_parent_1, '', $permissiontoadd)."\n";
	if(!empty($object->nom_parent_2))
	{
		print dolGetButtonAction($langs->trans('Créer un don parent 2'), '', 'default', '/don/card.php?leftmenu=donations&action=create&firstname='.$object->prenom_parent_2.'&lastname='.$object->nom_parent_2.'&fk_country=1&email='.$object->mail_parent_2.'&phone='.$object->tel_parent_2.'&address='.$object->adresse_parent_2, '', $permissiontoadd)."\n";
	}
	...
	print '<h2>Informations cours enfant(s)</h2>';
