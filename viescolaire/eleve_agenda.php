...
/**
 *  \file       eleve_agenda.php
 *  \ingroup    viescolaire
 *  \brief      Tab of events on Eleve
 */
...
$hookmanager->initHooks(array('eleveagenda', 'globalcard')); // Note that conf->hooks_modules contains array
...
if ($object->id > 0) {
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("Eleve"), -1, $object->picto);
	...
	// 	print load_fiche_titre($langs->trans("ActionsOnEleve"), '', '');
