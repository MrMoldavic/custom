...
/**
 *  \file       affectation_note.php
 *  \ingroup    viescolaire
 *  \brief      Tab for notes on Affectation
 */
...
$hookmanager->initHooks(array('affectationnote', 'globalcard')); // Note that conf->hooks_modules contains array
...
$help_url = '';
llxHeader('', $langs->trans('Affectation'), $help_url);
...
if ($id > 0 || !empty($ref)) {
	...
	print dol_get_fiche_head($head, 'note', $langs->trans("Affectation"), -1, $object->picto);
