...
/**
 *  \file       famille_note.php
 *  \ingroup    viescolaire
 *  \brief      Tab for notes on Famille
 */
...
$hookmanager->initHooks(array('famillenote', 'globalcard')); // Note that conf->hooks_modules contains array
...
$help_url = '';
llxHeader('', $langs->trans('Famille'), $help_url);
...
if ($id > 0 || !empty($ref)) {
	...
	print dol_get_fiche_head($head, 'note', $langs->trans("Famille"), -1, $object->picto);
