...
/**
 *  \file       eleve_contact.php
 *  \ingroup    viescolaire
 *  \brief      Tab for contacts linked to Eleve
 */
...
$hookmanager->initHooks(array('elevecontact', 'globalcard')); // Note that conf->hooks_modules contains array
...
$title = $langs->trans('Eleve')." - ".$langs->trans('ContactsAddresses');
$help_url = '';
...
if ($object->id) {
	...
	print dol_get_fiche_head($head, 'contact', $langs->trans("Eleve"), -1, $object->picto);
