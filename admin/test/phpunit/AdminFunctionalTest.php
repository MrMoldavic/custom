...
/**
 * \file    test/phpunit/AdminFunctionalTest.php
 * \ingroup admin
 ...
 * @package Testadmin
 */
class AdminFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/admin/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('admin/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/admin/admin/about.php');
		$this->authenticate();
		return $this->assertContains('admin/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('adminwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modAdmin_AdminTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modAdmin_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
