...
class FormSetup
{
	...
	public function addItemFromParams($confKey, $params)
	{
		 ...
		 * 	// 'ADMIN_MYPARAM1'=>array('type'=>'string', 'css'=>'minwidth500' ,'enabled'=>1),
			// 'ADMIN_MYPARAM2'=>array('type'=>'textarea','enabled'=>1),
			//'ADMIN_MYPARAM3'=>array('type'=>'category:'.Categorie::TYPE_CUSTOMER, 'enabled'=>1),
			//'ADMIN_MYPARAM4'=>array('type'=>'emailtemplate:thirdparty', 'enabled'=>1),
			//'ADMIN_MYPARAM5'=>array('type'=>'yesno', 'enabled'=>1),
			//'ADMIN_MYPARAM5'=>array('type'=>'thirdparty_type', 'enabled'=>1),
			//'ADMIN_MYPARAM6'=>array('type'=>'securekey', 'enabled'=>1),
			//'ADMIN_MYPARAM7'=>array('type'=>'product', 'enabled'=>1),
		 */
