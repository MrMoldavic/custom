...
class pdf_standard_emprunt extends ModelePDFEmprunt
{
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		/*
		if (!empty($conf->global->MAIN_GENERATE_EMPRUNT_WITH_PICTURE))
		{
		...
		*/
		...
		if ($conf->materiel->dir_output.'/emprunt') {
			$object->fetch_thirdparty();

			// Definition of $dir and $file
			if ($object->specimen) {
				$dir = $conf->materiel->dir_output.'/emprunt';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->materiel->dir_output.'/emprunt/'.$objectref;
