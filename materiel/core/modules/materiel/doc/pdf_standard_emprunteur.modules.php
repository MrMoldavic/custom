...
/**
 *  \file       core/modules/materiel/doc/pdf_standard.modules.php
 *  \ingroup    materiel
...
/**
 *	Class to manage PDF template standard_emprunteur
 */
class pdf_standard_emprunteur extends ModelePDFEmprunteur
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		/*
		if (!empty($conf->global->MAIN_GENERATE_EMPRUNTEUR_WITH_PICTURE))
		{
		...
		*/
		...
		if ($conf->materiel->dir_output.'/emprunteur') {
			$object->fetch_thirdparty();

			// Definition of $dir and $file
			if ($object->specimen) {
				$dir = $conf->materiel->dir_output.'/emprunteur';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->materiel->dir_output.'/emprunteur/'.$objectref;
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $outputlangsbis = null)
	{
		...
		if ($object->statut == $object::STATUS_DRAFT && getDolGlobalString('MATERIEL_DRAFT_WATERMARK')) {
			pdf_watermark($pdf, $outputlangs, $this->page_hauteur, $this->page_largeur, 'mm', dol_escape_htmltag(getDolGlobalString('MATERIEL_DRAFT_WATERMARK')));
		}
