...
$elementtype = 'materiel_myobject'; //Must be the $table_element of the class that manage extrafield
...
print load_fiche_titre($langs->trans("MaterielSetup"), $linkback, 'title_setup');
