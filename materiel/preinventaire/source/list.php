...
$sql = "SELECT DISTINCT s.rowid, s.fk_type_source, s.fk_source, s.fk_status";
...

	{
...

		{
...

			{
				...
				{
					$detail = "SELECT * FROM ".MAIN_DB_PREFIX."recu_fiscal_det WHERE fk_recu_fiscal = ".$obj->fk_source;
				}
				else
				{
					$detail = "SELECT * FROM ".MAIN_DB_PREFIX."facture_fourn_det WHERE fk_facture_fourn = ".$obj->fk_source;
				}
