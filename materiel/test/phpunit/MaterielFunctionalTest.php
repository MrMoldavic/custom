...
/**
 * \file    test/phpunit/MaterielFunctionalTest.php
 * \ingroup materiel
 ...
 *
 * @package Testmateriel
 */
class MaterielFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/materiel/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('materiel/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/materiel/admin/about.php');
		$this->authenticate();
		return $this->assertContains('materiel/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('materielwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modMateriel_MaterielTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modMateriel_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
