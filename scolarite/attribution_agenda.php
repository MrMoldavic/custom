...
/**
 *  \file       attribution_agenda.php
 *  \ingroup    scolarite
 *  \brief      Tab of events on Attribution
 */
...
$hookmanager->initHooks(array('attributionagenda', 'globalcard')); // Note that conf->hooks_modules contains array
...
if ($object->id > 0) {
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("Attribution"), -1, $object->picto);
	...
	if (isModEnabled('agenda') && (!empty($user->rights->agenda->myactions->read) || !empty($user->rights->agenda->allactions->read))) {
		...
		//print load_fiche_titre($langs->trans("ActionsOnAttribution"), '', '');
