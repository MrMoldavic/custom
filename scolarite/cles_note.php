...
$hookmanager->initHooks(array('clesnote', 'globalcard')); // Note that conf->hooks_modules contains array
...
$help_url = '';
$title = $langs->trans('Cles').' - '.$langs->trans("Notes");
...
if ($id > 0 || !empty($ref)) {
	...
	print dol_get_fiche_head($head, 'note', $langs->trans("Cles"), -1, $object->picto);
