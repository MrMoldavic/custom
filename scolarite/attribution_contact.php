...
/**
 *  \file       attribution_contact.php
 *  \ingroup    scolarite
 *  \brief      Tab for contacts linked to Attribution
 */
...
$hookmanager->initHooks(array('attributioncontact', 'globalcard')); // Note that conf->hooks_modules contains array
...
$title = $langs->trans('Attribution')." - ".$langs->trans('ContactsAddresses');
$help_url = '';
...
if ($object->id) {
	...
	print dol_get_fiche_head($head, 'contact', $langs->trans("Attribution"), -1, $object->picto);
