...
/**
 *  \file       cles_contact.php
 *  \ingroup    scolarite
 *  \brief      Tab for contacts linked to Cles
 */
...
$hookmanager->initHooks(array('clescontact', 'globalcard')); // Note that conf->hooks_modules contains array
...
$title = $langs->trans('Cles')." - ".$langs->trans('ContactsAddresses');
$help_url = '';
...
if ($object->id) {
	...
	print dol_get_fiche_head($head, 'contact', $langs->trans("Cles"), -1, $object->picto);
