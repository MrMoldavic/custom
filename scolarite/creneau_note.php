...
/**
 *  \file       creneau_note.php
 *  \ingroup    scolarite
 *  \brief      Tab for notes on Creneau
 */
...
$hookmanager->initHooks(array('creneaunote', 'globalcard')); // Note that conf->hooks_modules contains array
...
$help_url = '';
llxHeader('', $langs->trans('Creneau'), $help_url);
...
if ($id > 0 || !empty($ref)) {
	...
	print dol_get_fiche_head($head, 'note', $langs->trans("Creneau"), -1, $object->picto);
	...
	dol_banner_tab($object, 'ref', $linkback, 1, 'ref', 'nom_creneau', $morehtmlref);
