...
/**
 *  \file       creneau_contact.php
 *  \ingroup    scolarite
 *  \brief      Tab for contacts linked to Creneau
 */
...
$hookmanager->initHooks(array('creneaucontact', 'globalcard')); // Note that conf->hooks_modules contains array
...
$title = $langs->trans('Creneau')." - ".$langs->trans('ContactsAddresses');
$help_url = '';
...
if ($object->id) {
	...
	print dol_get_fiche_head($head, 'contact', $langs->trans("Creneau"), -1, $object->picto);
