...
/**
 *  \file       core/modules/scolarite/doc/pdf_standard.modules.php
 *  \ingroup    scolarite
...
/**
 *	Class to manage PDF template standard_dispositif
 */
class pdf_standard_dispositif extends ModelePDFDispositif
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		/*
		if (!empty($conf->global->MAIN_GENERATE_DISPOSITIF_WITH_PICTURE))
		{
		...
		*/
		...
		if ($conf->scolarite->dir_output.'/dispositif') {
			$object->fetch_thirdparty();

			// Definition of $dir and $file
			if ($object->specimen) {
				$dir = $conf->scolarite->dir_output.'/dispositif';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->scolarite->dir_output.'/dispositif/'.$objectref;
