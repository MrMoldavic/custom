 ...
 * Copyright (C) 2022 Baptiste Diodati <baptiste.diodati@gmail.com>
 *
...
/**
 * \file    scolarite/core/boxes/scolaritewidget1.php
 * \ingroup scolarite
 * \brief   Widget provided by Scolarite
 *
 ...
 */
class scolaritewidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "scolaritebox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "scolarite@scolarite";
	 ...
	 */
	public $depends = array('scolarite');
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		// Translations
		$langs->loadLangs(array("boxes", "scolarite@scolarite"));

		parent::__construct($db, $param);

		$this->boxlabel = $langs->transnoentitiesnoconv("Test widget Scolarite");

		$this->param = $param;

		//$this->enabled = $conf->global->FEATURES_LEVEL > 0;         // Condition when module is enabled or not
		//$this->hidden = ! ($user->rights->scolarite->myobject->read);   // Condition when module is visible by user (test on permission)
	}
	...
	public function loadBox($max = 5)
	{
		...
		//dol_include_once("/scolarite/class/scolarite.class.php");

		// Populate the head at runtime
		$text = $langs->trans("ScolariteBoxDescription", $max);
		$this->info_box_head = array(
			...
			'subpicto' => 'object_scolarite@scolarite',
