...
require_once __DIR__.'/class/cles.class.php';
...
$hookmanager->initHooks(array('cleslist')); // Note that conf->hooks_modules contains array
...
//$help_url = "EN:Module_Cles|FR:Module_Cles_FR|ES:Módulo_Cles";
$help_url = '';
$title = $langs->trans("Cless");
$morejs = array();
$morecss = array();
...
if ($num == 1 && !empty($conf->global->MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE) && $search_all && !$page) {
	...
	$id = $obj->rowid;
	header("Location: ".dol_buildpath('/scolarite/cles_card.php', 1).'?id='.$id);
	exit;
}
...
$newcardbutton .= dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/scolarite/cles_card.php', 1).'?action=create&backtopage='.urlencode($_SERVER['PHP_SELF']), '', $permissiontoadd);

print_barre_liste($title, $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, $massactionbutton, $num, $nbtotalofrecords, 'object_'.$object->picto, 0, $newcardbutton, '', $limit, 0, 0, 1);

// Add code for pre mass action (confirmation or email presend form)
$topicmail = "SendClesRef";
$modelmail = "cles";
$objecttmp = new Cles($db);
