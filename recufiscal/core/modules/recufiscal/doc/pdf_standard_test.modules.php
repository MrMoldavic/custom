...
/**
 *  \file       core/modules/recufiscal/doc/pdf_standard.modules.php
 *  \ingroup    recufiscal
...
class pdf_standard_test extends ModelePDFTest
{
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		/*
	    if (!empty($conf->global->MAIN_GENERATE_TEST_WITH_PICTURE))
	    {
		...
		*/
		...
		if ($conf->recufiscal->dir_output.'/test')
		{
			...
			if ($object->specimen)
			{
				$dir = $conf->recufiscal->dir_output.'/test';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->recufiscal->dir_output.'/test/'.$objectref;
