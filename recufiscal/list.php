...
$arrayfields = array(
	...
	'r.datec'=>array('label'=>'Date de création', 'checked'=>1, 'position'=>12),
...
print_liste_field_titre($arrayfields['r.datec']['label'], $_SERVER["PHP_SELF"], "r.datec", "", $param, "align='center'", $sortfield, $sortorder);
...

	{
...

		{
...

			{
    			...
    			print dol_print_date($recufiscal->datec, '%e %B %Y');
