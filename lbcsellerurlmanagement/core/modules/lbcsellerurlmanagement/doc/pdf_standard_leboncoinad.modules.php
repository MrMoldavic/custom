...
/**
 *  \file       core/modules/lbcsellerurlmanagement/doc/pdf_standard.modules.php
...
/**
 *	Class to manage PDF template standard_leboncoinad
 */
class pdf_standard_leboncoinad extends ModelePDFLeboncoinAd
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		/*
		if (!empty($conf->global->MAIN_GENERATE_LEBONCOINAD_WITH_PICTURE))
		{
		...
		*/
		...
		if ($conf->lbcsellerurlmanagement->dir_output.'/leboncoinad') {
			$object->fetch_thirdparty();

			// Definition of $dir and $file
			if ($object->specimen) {
				$dir = $conf->lbcsellerurlmanagement->dir_output.'/leboncoinad';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->lbcsellerurlmanagement->dir_output.'/leboncoinad/'.$objectref;
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $outputlangsbis = null)
	{
		...
		if ($object->statut == $object::STATUS_DRAFT && getDolGlobalString('LBCSELLERURLMANAGEMENT_DRAFT_WATERMARK')) {
			pdf_watermark($pdf, $outputlangs, $this->page_hauteur, $this->page_largeur, 'mm', dol_escape_htmltag(getDolGlobalString('LBCSELLERURLMANAGEMENT_DRAFT_WATERMARK')));
		}
