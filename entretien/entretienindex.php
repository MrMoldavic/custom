...
/**
 *	\file       entretien/entretienindex.php
 *	\ingroup    entretien
 *	\brief      Home page of entretien top menu
 */
...
$langs->loadLangs(array("entretien@entretien"));

$action = GETPOST('action', 'alpha');


// Security check
//if (! $user->rights->entretien->myobject->read) accessforbidden();
...
llxHeader("", $langs->trans("EntretienArea"));

print load_fiche_titre($langs->trans("EntretienArea"), '', 'entretien.png@entretien');
...
// Draft MyObject
if (! empty($conf->entretien->enabled) && $user->rights->entretien->read)
{
	$langs->load("orders");
