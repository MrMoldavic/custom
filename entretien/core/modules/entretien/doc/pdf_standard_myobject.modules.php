...
/**
 *  \file       entretien/core/modules/entretien/doc/pdf_standard.modules.php
 *  \ingroup    entretien
	...
	*/
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		*/
	    ...
	    if ($conf->entretien->dir_output.'/myobject')
	    {
	        ...
	        if ($object->specimen)
	        {
	        	$dir = $conf->entretien->dir_output.'/myobject';
	            $file = $dir."/SPECIMEN.pdf";
	        } else {
	            $objectref = dol_sanitizeFileName($object->ref);
	            $dir = $conf->entretien->dir_output.'/myobject/'.$objectref;
